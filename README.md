...
6. Featured-artist credits are assigned to the lead catalog artist. Related
   artist evidence also collapses both endpoints to their lead artists, so
   `Artist feat. Guest` never becomes a separate recommendation connection. The
   complete song title remains available for noteworthy matching and playlists.
